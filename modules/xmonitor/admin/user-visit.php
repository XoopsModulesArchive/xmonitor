...
echo "<img src=../images/dummy.gif align=\"right\"></a><p>";
 ...
 echo    "<CENTER>[ <A HREF=\"admin.php\">"._MD_USERVISIT_BACK."</A> | <A HREF=\"user-log.php\"> Back to Logs </A> |<A HREF=\"suppr-visit.php?su=mems\">"._MD_USERVISIT_DELSTAT."</A> ]</CENTER><P>";
...
$ii = ($i+1);
 ...
 echo "<tr class='bg1'><td><CENTER>$ii</CENTER></td><td> $supip</td><td><CENTER>$nvisite</CENTER></td><td><CENTER><FONT SIZE=1>$tems</FONT></CENTER></td><td><CENTER><FONT SIZE=1>$temss</FONT></CENTER></td><td><CENTER>". convert($temm) ."</CENTER></td></tr>";
